...
class FillDummyValueInspectionTest {
    ...
    fun setUp(testInfo: TestInfo) {
        ...
        SystemProperties.setProperty("idea.kotlin.plugin.use.k2", "true")
    ...
    fun tearDown() {
        ...
        SystemProperties.setProperty("idea.kotlin.plugin.use.k2", null)
        myFixture.tearDown()
        _myFixture = null
    }
...
//        )
    ...
    fun `test fill for non primitive types`() {
        ...
        // FIXME: fill generated constructor arguemnts
//        doAvailableTest(
//            """
